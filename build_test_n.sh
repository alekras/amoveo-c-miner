...
nvcc -keep -keep-dir assembler_code -Xptxas -O3 -lrt -lm -arch=compute_61 -code=sm_61,compute_61 -D_FORCE_INLINES -c -o amo_sha256_gpu_device.o src_c/amo_sha256_gpu_device_n.cu
